...
hl.bind(
	mainMod .. " + SHIFT + R",
	hl.dsp.exec_cmd(
		ipc .. "plugin noctalia/screen_recorder:service all toggle && notify-send 'Screen Recorder' 'Toggled'"
	)
)
hl.bind(mainMod .. " + SHIFT + G", hl.dsp.exec_cmd(ipc .. "plugin noctalia/screen_recorder:service all replay-save"))
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("~/.local/bin/toggle-mic.sh"))
